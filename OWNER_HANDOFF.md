...
2. Enter email → receive OTP code by email
3. Admin routes at `/ar/admin` require assigned roles
...
- OTP and notifications sent via SMTP (`EMAIL_PROVIDER=smtp`)
- Failed deliveries visible on admin dashboard
